...
// 设置超时时间
    ...
    public static void main(String args[]) throws IOException {
        ...
        String filePath = "E:\\project\\file\\10MB.txt";
...
//准备调用请求
        ...
        //获取客户端:
        OldAWSClient.init(AWSSecretId,AWSSecretKey,regionName);



// 调用 Lambda 函数并处理调用的响应
        InvokeResponse response = OldAWSClient.lambdaClient.invoke(request);
